...
# Face Recognition Attendance UI Startup Script
# Ensures proper display environment and launches the attendance system

echo "Starting Face Recognition Attendance UI..."
...
# Launch the attendance UI
echo "Launching Face Recognition Attendance UI..."
python3 face_recognition_attendance_ui.py 